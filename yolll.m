...
% Last Modified by GUIDE v2.5 09-Jun-2022 13:38:56
...
handles.yoluzunlugu=str2num(get(handles.edit6,'string'))


for p=1:1:(handles.yoluzunlugu)

handles.hiz=str2num(get(handles.edit4,'string'));
handles.metre=(handles.hiz*1000/3600);

% her metre için 1 fotoðraf çekeceðini varsayarsak
for i=1:1:handles.metre
    
    if (p==handles.yoluzunlugu)
        break
    else
